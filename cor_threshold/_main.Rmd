...
```{r setup, include=FALSE}
  setwd('~/repositories/correlates_reporting2_fork')
#TRIAL <- "profiscov_lvmn"
 #Sys.setenv(TRIAL=TRIAL)

TRIAL <- Sys.getenv("TRIAL")
# print("TRIAL")
#TRIAL <- "janssen_la_partA"
Sys.setenv(TRIAL = TRIAL)  
...
if(above) {
  ...
  if(tolower(TRIAL) %in% c("hvtn705", "hvtn705second")) {
